...
"use strict";
module.exports = __webpack_require__.p + "src/assets/fonts/DMSans//DMSans-Regular..ttf";
...
"use strict";
module.exports = __webpack_require__.p + "src/assets/fonts/DMSans//DMSans-Medium..ttf";
...
/* harmony export */ });
var blocLinks = document.querySelector('.bloc-links');
var btnDrop = document.querySelector('.btn-top');
var liItems = document.querySelectorAll('.dropdown li');
...
function toggleDropDown() {
  if (!toggleIndex) {
    blocLinks.style.height = "".concat(blocLinks.scrollHeight, "px");
...
liItems.forEach(function (li) {
  return li.addEventListener('click', toggleDropDown);
});
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            photographersSection = document.querySelector('.all-photographers');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            displayData(photographers); // console.log(photographers);
...
function photographerFactory(data) {
  var name = data.name,
      ...
      price = data.price;
  var picture = "../../assets/images/Photographers ID Photos/".concat(portrait);
  ...
  function getUserCardDOM() {
    ...
    img.setAttribute('alt', "photo du photographe ".concat(name));
...
/* harmony export */ });
var modal = document.querySelector('.content-form-modal');
var contact = document.querySelector('#btn-contact');
var btnCloseContact = document.querySelector('.close-contact');
console.log(contact); // launch modal event

contact.addEventListener('click', displayModal); // close modal event
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_fonts_DMSans_DMSans_Regular_ttf__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _assets_fonts_DMSans_DMSans_Medium_ttf__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _assets_scss_main_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _data_photographers_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _scripts_select_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
/* harmony import */ var _scripts_form_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
/* harmony import */ var _scripts_pages_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6);
/* harmony import */ var _scripts_pages_index__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_scripts_pages_index__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _scripts_factories_photographer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7);
/* harmony import */ var _scripts_factories_photographer__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_scripts_factories_photographer__WEBPACK_IMPORTED_MODULE_7__);
